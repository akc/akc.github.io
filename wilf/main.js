...
var _akc$wilf$Perm$commonPrefix = F3(
	function (n, xs, ys) {
			...
			if (_p0._0.ctor === '::') {
				if (_p0._1.ctor === '::') {
					...
					if (_elm_lang$core$Native_Utils.eq(_p2, _p0._1._0)) {
						var _p1 = A3(_akc$wilf$Perm$commonPrefix, n - 1, _p0._0._1, _p0._1._1);
						if (_p1.ctor === 'Just') {
							return _elm_lang$core$Maybe$Just(
								{ctor: '::', _0: _p2, _1: _p1._0});
						} else {
							return _elm_lang$core$Maybe$Nothing;
						}
					} else {
...
var _akc$wilf$Perm$backelinWestXinAux = F2(
	function (n, w) {
		var xs = _elm_lang$core$List$sort(w);
		var ys = _elm_lang$core$List$reverse(xs);
		var vs = function () {
			var _p3 = A3(_akc$wilf$Perm$commonPrefix, n, ys, w);
			if (_p3.ctor === 'Nothing') {
				return {ctor: '[]'};
			} else {
				var _p4 = _p3._0;
		...
		var us = function () {
			var _p5 = A3(_akc$wilf$Perm$commonPrefix, n, xs, w);
			if (_p5.ctor === 'Nothing') {
				return {ctor: '[]'};
			} else {
				var _p6 = _p5._0;
		...
		return A2(_elm_lang$core$Basics_ops['++'], us, vs);
	});
var _akc$wilf$Perm$backelinWestXin = function (w) {
	var n = _elm_lang$core$List$length(w);
	return A2(
		_elm_lang$core$List$concatMap,
		function (k) {
			return A2(_akc$wilf$Perm$backelinWestXinAux, k, w);
		},
		A2(_elm_lang$core$List$range, 2, n - 1));
};
var _akc$wilf$Perm$stankovaWest = function (w) {
	var _p7 = w;
	_v4_2:
	do {
...
var _akc$wilf$Perm$stankova = function (w) {
	var _p8 = w;
	_v5_2:
	do {
		if (((((_p8.ctor === '::') && (_p8._1.ctor === '::')) && (_p8._1._1.ctor === '::')) && (_p8._1._1._1.ctor === '::')) && (_p8._1._1._1._1.ctor === '[]')) {
			switch (_p8._0) {
				case 1:
					if (((_p8._1._0 === 3) && (_p8._1._1._0 === 4)) && (_p8._1._1._1._0 === 2)) {
						return {
							ctor: '::',
							_0: {
								ctor: '::',
				...
				case 2:
					if (((_p8._1._0 === 4) && (_p8._1._1._0 === 1)) && (_p8._1._1._1._0 === 3)) {
						return {
							ctor: '::',
							_0: {
								ctor: '::',
...
var _akc$wilf$Perm$flipV = _elm_lang$core$List$reverse;
var _akc$wilf$Perm$r0 = _elm_lang$core$Basics$identity;
var _akc$wilf$Perm$orbit = F2(
	function (fs, x) {
...
var _akc$wilf$Perm$inverse = function (xs) {
	var n = _elm_lang$core$List$length(xs);
		...
		_elm_lang$core$List$unzip(
			_elm_lang$core$List$sort(
				A3(
					...
					xs,
					_elm_lang$core$List$sort(xs)))));
};
var _akc$wilf$Perm$flipD = _akc$wilf$Perm$inverse;
var _akc$wilf$Perm$r90 = function (_p9) {
	return _akc$wilf$Perm$flipV(
		_akc$wilf$Perm$flipD(_p9));
};
var _akc$wilf$Perm$r180 = function (_p10) {
	return _akc$wilf$Perm$r90(
		_akc$wilf$Perm$r90(_p10));
};
var _akc$wilf$Perm$flipH = function (_p11) {
	return _akc$wilf$Perm$r180(
		_akc$wilf$Perm$flipV(_p11));
};
var _akc$wilf$Perm$r270 = function (_p12) {
	return _akc$wilf$Perm$r90(
		_akc$wilf$Perm$r180(_p12));
};
var _akc$wilf$Perm$flipA = function (_p13) {
	return _akc$wilf$Perm$r90(
		_akc$wilf$Perm$flipV(_p13));
};
var _akc$wilf$Perm$complement = function (xs) {
	var n = _elm_lang$core$List$length(xs);
	return A2(
		_elm_lang$core$List$map,
		function (x) {
...
var _akc$wilf$Parse$charToInt = function (c) {
	return _elm_lang$core$Char$toCode(c) - _elm_lang$core$Char$toCode(
		_elm_lang$core$Native_Utils.chr('0'));
};
var _akc$wilf$Parse$spaces = A2(
	_elm_tools$parser$Parser$ignore,
...
var _akc$wilf$Parse$seqConf = {start: '', separator: ',', end: '', spaces: _akc$wilf$Parse$spaces, item: _elm_tools$parser$Parser$int, trailing: _elm_tools$parser$Parser_LanguageKit$Optional};
var _akc$wilf$Parse$intSeq = _elm_tools$parser$Parser_LanguageKit$sequence(_akc$wilf$Parse$seqConf);
var _akc$wilf$Parse$intList = A2(_elm_tools$parser$Parser_LanguageKit$list, _akc$wilf$Parse$spaces, _elm_tools$parser$Parser$int);
var _akc$wilf$Parse$parseInts = function (str) {
	var _p0 = _elm_lang$core$String$toInt(str);
	if (_p0.ctor === 'Ok') {
		return _elm_lang$core$Result$Ok(
			A2(
				_elm_lang$core$List$map,
				_akc$wilf$Parse$charToInt,
		...
		return A2(
			...
			A2(
				...
				_elm_tools$parser$Parser$oneOf(
					{
						ctor: '::',
						_0: _akc$wilf$Parse$intList,
						_1: {
							ctor: '::',
							_0: _akc$wilf$Parse$intSeq,
							_1: {ctor: '[]'}
						}
					}),
...
var _akc$wilf$Main$onEnter = function (tagger) {
	var isEnter = function (code) {
		return _elm_lang$core$Native_Utils.eq(code, 13) ? _elm_lang$core$Json_Decode$succeed('') : _elm_lang$core$Json_Decode$fail('');
	};
	var decodeEnter = A2(_elm_lang$core$Json_Decode$andThen, isEnter, _elm_lang$html$Html_Events$keyCode);
	return A2(
		_elm_lang$html$Html_Events$on,
		'keydown',
		A3(
...
var _akc$wilf$Main$bStyle = _elm_lang$html$Html_Attributes$style(
	{
		ctor: '::',
		_0: {ctor: '_Tuple2', _0: 'color', _1: 'red'},
		_1: {ctor: '[]'}
	});
var _akc$wilf$Main$tableStyle = _elm_lang$html$Html_Attributes$style(
	{
		ctor: '::',
...
var _akc$wilf$Main$h1Style = _elm_lang$html$Html_Attributes$style(
	{
		ctor: '::',
		_0: {ctor: '_Tuple2', _0: 'margin', _1: '15px 0px 10px 0px'},
		_1: {
			ctor: '::',
			_0: {ctor: '_Tuple2', _0: 'text-indent', _1: '15px'},
			_1: {
				ctor: '::',
				_0: {ctor: '_Tuple2', _0: 'font-size', _1: '2.4em'},
				_1: {
					ctor: '::',
			...
			_0: A2(
				...
				{ctor: '[]'},
				{
					...
					_1: {
						...
						_1: {
							ctor: '::',
							_0: _elm_lang$html$Html$text(' - Clockwise rotation by α degrees'),
							_1: {ctor: '[]'}
						}
					}
				}),
...
var _akc$wilf$Main$toggleName = F2(
	function (name, model) {
		return A2(_elm_lang$core$Set$member, name, model.names) ? _elm_lang$core$Native_Utils.update(
			model,
			{
				names: A2(_elm_lang$core$Set$remove, name, model.names)
			}) : _elm_lang$core$Native_Utils.update(
			model,
			{
				names: A2(_elm_lang$core$Set$insert, name, model.names)
			});
	});
var _akc$wilf$Main$isPerm = function (w) {
	return _elm_lang$core$Native_Utils.eq(
		w,
		_elm_community$list_extra$List_Extra$unique(w));
};
var _akc$wilf$Main$image = F2(
	function (model, _p0) {
		var _p1 = _p0;
		var _p2 = model.perm;
		if (_p2.ctor === 'Ok') {
			return _p1._1(_p2._0);
		} else {
			return {ctor: '[]'};
		}
	});
var _akc$wilf$Main$imageSet = F2(
	function (model, fs) {
		return _elm_lang$core$Set$fromList(
			A2(
				_elm_lang$core$List$concatMap,
				_akc$wilf$Main$image(model),
				fs));
	});
var _akc$wilf$Main_ops = _akc$wilf$Main_ops || {};
_akc$wilf$Main_ops['>>>'] = F2(
	function (_p4, _p3) {
		var _p5 = _p4;
		var _p6 = _p3;
		return {
			ctor: '_Tuple2',
			_0: A2(_elm_lang$core$Basics_ops['++'], _p5._0, _p6._0),
			_1: function (_p7) {
				return A2(
					_elm_lang$core$List$concatMap,
					_p6._1,
...
var _akc$wilf$Main$composeAll = F2(
	function (fs, gs) {
		return A3(
			_elm_community$list_extra$List_Extra$lift2,
			F2(
				function (x, y) {
					return A2(_akc$wilf$Main_ops['>>>'], x, y);
				}),
			fs,
			gs);
	});
var _akc$wilf$Main$gen = {
	ctor: '::',
	_0: {
		ctor: '_Tuple2',
		_0: {
								...
								_1: {
									...
									_1: {
										...
										_0: {
											...
											_1: _akc$wilf$Perm$stankovaWest
										},
										_1: {
											ctor: '::',
											_0: {
												...
												_1: _akc$wilf$Perm$backelinWestXin
											},
											_1: {ctor: '[]'}
										}
									}
...
var _akc$wilf$Main$funs = function (names) {
	return A2(
		_elm_lang$core$List$filter,
		function (_p16) {
			var _p17 = _p16;
			return A2(_elm_lang$core$Set$member, _p17._0, names);
		},
		_akc$wilf$Main$gen);
};
var _akc$wilf$Main$closureAux = F2(
	function (model, fs) {
		closureAux:
		while (true) {
			var hs = _akc$wilf$Main$funs(model.names);
			var gs = A2(
				_elm_community$list_extra$List_Extra$uniqueBy,
				_akc$wilf$Main$image(model),
				A2(_akc$wilf$Main$composeAll, hs, fs));
			if (_elm_lang$core$Native_Utils.eq(
				A2(_akc$wilf$Main$imageSet, model, fs),
				A2(_akc$wilf$Main$imageSet, model, gs))) {
				return gs;
			} else {
				var _v5 = model,
					_v6 = gs;
...
var _akc$wilf$Main$closure = function (model) {
	return _elm_lang$core$Native_Utils.update(
		model,
		{
			funs: A2(
				_akc$wilf$Main$closureAux,
				model,
				_akc$wilf$Main$funs(model.names))
		});
};
var _akc$wilf$Main$update = F2(
	function (msg, model) {
		var _p18 = msg;
		if (_p18.ctor === 'NewPerm') {
			var _p19 = _akc$wilf$Parse$parseInts(_p18._0);
			if (_p19.ctor === 'Ok') {
				var _p20 = _p19._0;
				return _akc$wilf$Main$isPerm(_p20) ? _akc$wilf$Main$closure(
					_elm_lang$core$Native_Utils.update(
						model,
						{
							perm: _elm_lang$core$Result$Ok(_p20)
						})) : _elm_lang$core$Native_Utils.update(
					model,
					{
						perm: _elm_lang$core$Result$Err(
							A2(
								_elm_lang$core$Basics_ops['++'],
				...
				return _elm_lang$core$Native_Utils.update(
					...
					{
						perm: _elm_lang$core$Result$Err(
							_elm_lang$core$Basics$toString(_p19._0.problem))
					});
			}
		} else {
			return _akc$wilf$Main$closure(
				A2(_akc$wilf$Main$toggleName, _p18._0, model));
		}
	});
var _akc$wilf$Main$genNames = A2(_elm_lang$core$List$map, _elm_lang$core$Tuple$first, _akc$wilf$Main$gen);
var _akc$wilf$Main$pretty = function (name) {
	var _p21 = name;
	switch (_p21) {
		case '':
			return {
			...
			return {
				...
				_1: {
					...
					_0: A2(
						...
						{
							ctor: '::',
							_0: _elm_lang$html$Html$text('90'),
							_1: {ctor: '[]'}
						}),
					_1: {ctor: '[]'}
				}
			...
			return {
				...
				_1: {
					...
					_0: A2(
						...
						{
							ctor: '::',
							_0: _elm_lang$html$Html$text('180'),
							_1: {ctor: '[]'}
						}),
					_1: {ctor: '[]'}
				}
			...
			return {
				...
				_1: {
					...
					_0: A2(
						...
						{
							ctor: '::',
							_0: _elm_lang$html$Html$text('270'),
							_1: {ctor: '[]'}
						}),
					_1: {ctor: '[]'}
				}
		...
		case 'SW':
			return {
				ctor: '::',
				_0: _elm_lang$html$Html$text('SW'),
				_1: {ctor: '[]'}
			};
		case 'BWX':
			return {
				ctor: '::',
				_0: _elm_lang$html$Html$text('BWX'),
				_1: {ctor: '[]'}
			};
		default:
			return {ctor: '[]'};
...
var _akc$wilf$Main$showNamedFun = function (_p22) {
	var _p23 = _p22;
	var _p24 = A2(
	...
	if (_p24.ctor === '[]') {
		...
		return A2(
			...
			A2(_elm_lang$core$List$map, _akc$wilf$Main$pretty, _p24));
	}
};
var _akc$wilf$Main$viewTable = function (model) {
	var _p25 = model.perm;
	if (_p25.ctor === 'Ok') {
		return A2(
								...
								{ctor: '[]'},
								{
									...
									_1: {
										...
										_0: A2(
											...
											_akc$wilf$Main$showNamedFun(f)),
										_1: {ctor: '[]'}
									}
								});
						},
						A2(_akc$wilf$Main$image, model, f));
				},
				model.funs));
	} else {
		return A2(
			...
			{
				ctor: '::',
				_0: _akc$wilf$Main$bStyle,
				_1: {ctor: '[]'}
			},
			{
				ctor: '::',
				_0: _elm_lang$html$Html$text(
					A2(_elm_lang$core$Basics_ops['++'], 'Error: ', _p25._0)),
				_1: {ctor: '[]'}
			});
	}
};
var _akc$wilf$Main$initialModel = function () {
	var names = _elm_lang$core$Set$fromList(_akc$wilf$Main$genNames);
	return _akc$wilf$Main$closure(
		{
			perm: _elm_lang$core$Result$Ok(
				{
					ctor: '::',
					_0: 1,
					_1: {
			...
			names: names,
			funs: _akc$wilf$Main$funs(names)
		});
}();
var _akc$wilf$Main$Model = F3(
	function (a, b, c) {
		return {perm: a, names: b, funs: c};
	});
var _akc$wilf$Main$ToggleName = function (a) {
	return {ctor: 'ToggleName', _0: a};
};
var _akc$wilf$Main$NewPerm = function (a) {
	return {ctor: 'NewPerm', _0: a};
};
							...
							_0: _elm_lang$html$Html_Attributes$style(
								{
									...
									_1: {
										ctor: '::',
										_0: {ctor: '_Tuple2', _0: 'border-bottom', _1: '0px'},
										_1: {ctor: '[]'}
									}
								}),
							_1: {
								ctor: '::',
								_0: _elm_lang$html$Html_Attributes$href('http://akc.is'),
								_1: {ctor: '[]'}
							}
						},
						{
							ctor: '::',
							_0: _elm_lang$html$Html$text('akc.is/'),
							_1: {ctor: '[]'}
						}),
					_1: {
						ctor: '::',
						_0: _elm_lang$html$Html$text('wilf'),
						_1: {ctor: '[]'}
					}
				}),
			_1: {
					...
					{ctor: '[]'},
					{
						...
						_1: {
							...
							_0: A2(
								...
								{
									ctor: '::',
									_0: _elm_lang$html$Html_Attributes$placeholder('[1,2,5,3,4]'),
									_1: {
										ctor: '::',
										_0: _akc$wilf$Main$onEnter(_akc$wilf$Main$NewPerm),
										_1: {
											ctor: '::',
											_0: _akc$wilf$Main$inputStyle,
											_1: {ctor: '[]'}
										}
									}
								},
...
var _akc$wilf$Main$main = _elm_lang$html$Html$beginnerProgram(
	{model: _akc$wilf$Main$initialModel, view: _akc$wilf$Main$view, update: _akc$wilf$Main$update})();

var Elm = {};
Elm['Main'] = Elm['Main'] || {};
if (typeof _akc$wilf$Main$main !== 'undefined') {
    _akc$wilf$Main$main(Elm['Main'], 'Main', undefined);
}
