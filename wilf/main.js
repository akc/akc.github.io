...
var _akc$wilf$Main$showNamedFun = function (_p21) {
	var _p22 = _p21;
	var _p23 = A2(
	...
	if (_p23.ctor === '[]') {
		...
		return A2(_elm_lang$core$String$join, '∘', _p23);
	}
};
	...
	if (_p24.ctor === 'Ok') {
		...
		return A2(
			...
			},
			{
				ctor: '::',
				_0: _elm_lang$html$Html$text(
					A2(_elm_lang$core$Basics_ops['++'], 'Error: ', _p24._0)),
				_1: {ctor: '[]'}
			});
	}
};
	...
	return A2(
		...
		},
		{
			...
			_0: A2(
				...
				{
					ctor: '::',
					_0: _elm_lang$html$Html$text('akc.is/wilf'),
					_1: {ctor: '[]'}
				}),
			_1: {
				ctor: '::',
